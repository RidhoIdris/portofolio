    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className="h-full pb-20 flex flex-col justify-center items-center">
                    ...
                    <div className="flex mt-6 none px-2 py-2 inline-block -md:flex-col -md:space-y-2 md:space-x-2">
            ...
            <div style={{backgroundColor:'#f2f2f2'}} className="bg-green-800 text-gray-700 px-8 py-2 flex -md:flex-col justify-between">
                <div>
                    ...
                    <span className="hover:underline hover:cursor-pointer ml-3 sm:ml-8">Bisnis</span>
                    <span className="hover:underline hover:cursor-pointer ml-3 sm:ml-8">Tentang</span>
                    <span className="hover:underline hover:cursor-pointer ml-3 sm:ml-8">Cara Kerja Penulusuran</span>
                </div>
                <div>
                    <span className="hover:underline hover:cursor-pointer mr-3 sm:mr-8">Privasi</span>
                    <span className="hover:underline hover:cursor-pointer mr-3 sm:mr-8">Persyaratan</span>
